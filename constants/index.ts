...
export const technologies = [
  // Languages
  { name: "C++", icon: "/tech/cpp.png", category: "Languages" },
  { name: "C#", icon: "/tech/csharp.png", category: "Languages" },
  { name: "Java", icon: "/tech/java.png", category: "Languages" },
  { name: "Python", icon: "/tech/python.png", category: "Languages" },
  { name: "JavaScript", icon: "/tech/javascript.png", category: "Languages" },
  { name: "TypeScript", icon: "/tech/typescript.png", category: "Languages" },
  { name: "Go", icon: "/tech/go.png", category: "Languages" },
  { name: "R", icon: "/tech/r.png", category: "Languages" },
  { name: "MATLAB", icon: "/tech/matlab.png", category: "Languages" },

  // Frontend Technologies
  { name: "HTML 5", icon: "/tech/html.png", category: "Frontend" },
  { name: "CSS 3", icon: "/tech/css.png", category: "Frontend" },
  { name: "Tailwind CSS", icon: "/tech/tailwind.svg", category: "Frontend" },
  { name: "Bootstrap", icon: "/tech/bootstrap.png", category: "Frontend" },
  { name: "React.js", icon: "/tech/reactjs.png", category: "Frontend" },
  { name: "Next.js", icon: "/tech/nextjs.svg", category: "Frontend" },
  { name: "Three.js", icon: "/tech/threejs.png", category: "Frontend" },
  { name: "Extra", icon: "/", category: "Frontend" },
  { name: "Extra", icon: "/", category: "Frontend" },

  // Backend Technologies
  { name: "Node.js", icon: "/tech/nodejs.png", category: "Backend" },
  { name: "Django", icon: "/tech/django.png", category: "Backend" },
  { name: "ASP.NET", icon: "/tech/aspnet.png", category: "Backend" },
  { name: "Extra", icon: "/", category: "Backend" },
  { name: "Extra", icon: "/", category: "Backend" },
  { name: "Extra", icon: "/", category: "Backend" },
  { name: "Extra", icon: "/", category: "Backend" },
  { name: "Extra", icon: "/", category: "Backend" },
  ...
  // Databases
  { name: "SQL", icon: "/tech/sql.png", category: "Databases" },
  { name: "PostgreSQL", icon: "/tech/postgresql.svg", category: "Databases" },
  { name: "Extra", icon: "/", category: "Databases" },
  { name: "Extra", icon: "/", category: "Databases" },
  { name: "Extra", icon: "/", category: "Databases" },
  { name: "Extra", icon: "/", category: "Databases" },
  { name: "Extra", icon: "/", category: "Databases" },
  ...
  // Tools
  { name: "XML", icon: "/tech/xml.png", category: "Tools" },
  { name: "Git", icon: "/tech/git.png", category: "Tools" },
