            ...
            >
              ...
              <td className="px-4 py-2 font-semibold">
                {project.read_more && (
                  <a
                    ...
                    className="space-x-1 hover:text-blue-400 text-hover"
                  >
                    {/* Project Name */}
                    <span>
                      {project.name}
              ...
              <td className="px-4 py-2">
                {project.tags.map((tag, i) => (
                  <span key={i} className="bg-blue-100 text-[#0B1B2D] text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">
                    {tag}
                  </span>
                ))}
              </td>
              ...
              <td className="px-4 py-2">
                ...
                {project.source_code_link && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-secondary hover:text-blue-400 text-hover space-x-2"
                  >
                    {/* Github Icon */}
                    <svg
                ...
                {project.source_code_link && project.website_link && <br />}
                {/* Display Webs Link if exist */}
                {project.website_link && (
                  <a
                    href={project.website_link}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-secondary hover:text-blue-400 text-hover space-x-1 mt-1"
                  >
                    <span>Live Demo</span>
                    {/* Arrow icon */}
                    <svg
